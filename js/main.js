...
/*!***********************************!*\
  !*** ./js/modules/menu-mobile.js ***!
  \***********************************/
/*! exports provided: initShowMenu, initRemoveMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"initShowMenu\", function() { return initShowMenu; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"initRemoveMenu\", function() { return initRemoveMenu; });\n/* harmony import */ var _outsideClick_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./outsideClick.js */ \"./js/modules/outsideClick.js\");\n\n\nfunction initShowMenu() {\n  const menuHamb = document.querySelector(\".hamburguer\");\n\n  function showMenu() {\n    const menu = document.querySelector(\".menu ul\");\n    const menus = menuHamb.querySelectorAll(\"div\");\n\n    menu.classList.toggle(\"menu-open\");\n    menus.forEach((div) => {\n      div.classList.toggle(\"active\");\n    });\n\n    Object(_outsideClick_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(menu, [\"click\", \"touchstart\"], () => {\n      menu.classList.remove(\"menu-open\");\n\n      menus.forEach((div) => {\n        div.classList.remove(\"active\");\n      });\n    });\n  }\n\n  menuHamb.addEventListener(\"click\", showMenu);\n}\n\nfunction initRemoveMenu() {\n  function removeMenu() {\n    const menuHamb = document.querySelector(\".hamburguer\");\n    const menu = document.querySelector(\".menu ul\");\n    const menus = menuHamb.querySelectorAll(\"div\");\n\n    menus.forEach((div) => {\n      div.classList.remove(\"active\");\n    });\n\n    if (window.pageYOffset > menu.offsetTop) {\n      menu.classList.remove(\"menu-open\");\n    }\n  }\n  document.addEventListener(\"scroll\", removeMenu);\n}\n\n\n//# sourceURL=webpack:///./js/modules/menu-mobile.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return initScrollWindow; });\nfunction initScrollWindow() {\n  const sections = document.querySelectorAll('[data-anime=\"scroll\"]');\n  const windowMetade = window.innerHeight * 0.6;\n\n  function animateScroll() {\n    sections.forEach((item) => {\n      const sectionTop = item.getBoundingClientRect().top;\n      const isSectionVisible = sectionTop - windowMetade < 0;\n\n      if (isSectionVisible) {\n        item.classList.add(\"ativo\");\n      } else if (item.classList.contains(\"ativo\")) {\n        item.classList.remove(\"ativo\");\n      }\n    });\n  }\n\n  if (sections.length) {\n    animateScroll();\n    window.addEventListener(\"scroll\", animateScroll);\n  }\n}\n\n\n//# sourceURL=webpack:///./js/modules/scroll-window.js?");
