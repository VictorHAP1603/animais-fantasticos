export default function initFetchBitcoin() {
    ...
    async function getBitcoin(url) {
        try {
            ...
            // Se resolve primeiro o que está em entre parenteses, nisso, me retorna a 'Response', após irá retornar o JSON completo com o await e .json() fora dos parenteses 
